...
%         \tableheader{Roll} & \tableheader{Skill Dice} & \tableheader{Difficulty Dice}\\
%         \toprule
...
% \begin{center}
%     \noindent\begin{tabular}{@{}m{1in}m{1in}m{1in}@{}}
%         \textbf{General} & \textbf{Social} & \textbf{Combat}\\
%         \toprule
%         Driving & Charm & Brawl\\
%         \addlinespace[1ex]
...
\ul{
    ...
    \item Flaws need to bne part of the motivation system, those would be a great place for keepers to use Karma points
    \ul{
...
%     \item The Narrator can use Karma points to trigger phobias, manias, delusions, ...
...
\ul{
    ...
    \ul{
        ...
        \ul{
            ...
            \item Or... Karma points for crits? This has potential! :p
        }
    }
