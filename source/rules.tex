...
\ul{
    ...
    \ul{
        ...
        \ul{
            ...
            \ul{
                \item Some options: reduce it by a fixed amount, reduce it by the level of the bond, number of unopposed successes rolled, 
                \item \textit{or my favourite:} roll Bond with a difficulty of the stress loss, if you succeed you negate all of it, if you fail you still negate it all, but your bonds lowers by one  
            }
            \item just need a nice way to (re)improve and/or gain new bonds for the sake of longer-term games
        }
    }
