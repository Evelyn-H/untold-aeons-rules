...
\begin{multicols}{2}
    ...
    {Locksmithing, Sleight of Hand, Appraise, Electronics or Mechanics}
    ...
    {Navigation, Mechanics, Language (Any), Any skill as specialty}
...
\fancytable[1.5]{lll}
{
    ...
    Accounting                      & Language \textit{(Specific)}  & Operating                     \\
    Appraise                        & Law                           & Piloting                      \\
    Animal Handling                 & Locksmithing                  & Psychoanalysis                \\
    Art/Craft \textit{(Specific)}   & Mechanics                     & Science \textit{(Specific)}   \\
    Disguise                        & Medicine                      & Sleight of Hand               \\
