...
\fancytable[1.5]{lll}
{
    ...
    Accounting                      & Language \textit{(Specific)}  & Occult \\
    Appraise                        & Law                           & Operating \\
    Art/Craft \textit{(Specific)}   & Locksmithing                  & Piloting \\
    Disguise                        & Mechanics                     & Psychoanalysis \\
    Electronics                     & Medicine                      & Science \textit{(Specific)} \\
    History                         & Navigation                    & Sleight of Hand\\
}{}
