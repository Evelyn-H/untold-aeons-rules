...
so a weapon dealing "3+" damage will have a base damage of $3+\lceil\frac{Tougness}{2}\rceil$.

Unarmed attacks always have a base damage of "0+", i.e. your Toughness without any bonuses
...
They can only be triggered by spending a Story point after landing the hit. 
...
\fancytable{ccccc}
{
    & \thead{$Point\ Blank$} & \thead{$\leq Range$} & \thead{$\leq 2*Range$} & \thead{$\geq 2*Range$}\\
}{
...
The combatant who's being shot at is aware they're being shot at they have the option to try diving away.
